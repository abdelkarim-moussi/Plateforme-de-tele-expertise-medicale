...
public class PatientRegistrationServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/nurse/patientRegister.jsp").forward(request,response);
    }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response){
        ...
        if(this.validateFields(firstName,lastName,email,phone,
            ...
            try{
                ...
                patientService.registerPatient(firstName,lastName,email,phone, LocalDate.parse(dateOfBirth), securityNumber, address, CNI,medicalData,vitalSigns);
